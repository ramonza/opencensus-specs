...
| grpc.io/client/sent_bytes_per_rpc        | By   | Total bytes sent in across request messages in an RPC.                                        |
| grpc.io/client/received_messages_per_rpc | 1    | Number of response messages received in an RPC (always `1` for non-streaming RPCs).           |
| grpc.io/client/received_bytes_per_rpc    | By   | Total bytes received across all response messages in an RPC.                                  |
...
| grpc.io/server/send_bytes_per_rpc        | By   | Total bytes sent in across all response messages in a RPC request.                            |
